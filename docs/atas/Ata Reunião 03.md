...
| Nº | Descrição | Tipo |
|----|-----------|--------|
| 1  | Revisamos o cronograma planejado para a entrega 2. | Apresentação |
| 2  | Anotamos todas as alterações a serem feitas, relacionadas a entrega 1, onde deixamos essas como responsabilidades do Artur, do Davi e do Pedro. | Decisão |
| 3  | Atribuímos ao Gabriel a tarefa de fazer o Rich Picture do Cinemark. | Decisão |
| 4  | Definimos que as técnicas de elicitação a serem utilizadas, juntamente com as pessoas responsáveis pelas mesmas, serão: Introspecção (Arthur e Euller), Personas e Perfil de usuário (Davi e Pedro), Brainstorming (Arthur e Euller), Storytelling (Gabriel e Tiago) e Questionário (Artur e Tiago). | Decisão |
| 5  | Decidimos esperar a aula de quinta (24/04) para selecionarmos as técnicas de priorização do projeto. | Decisão |
...
- <a href="https://youtu.be/c9khLWNO4e4&t=1" target="_blank">Gravação da reunião</a>
